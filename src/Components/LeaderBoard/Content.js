    ...
    const fetchData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.log("Using predefined URL");
        }
        ...
        if (jsonResult.status === "OK") {
          const sortedItems = jsonResult.result.sort((a, b) => {
            if (iscur === 1) {
        ...
        >
          ...
          {displayedObjects.map((item, index) => (
            ...
            >
              ...
              {windowWidth > 550 && (
                <div className="w-3/12 avatarImg justify-center flex">
                  <a
